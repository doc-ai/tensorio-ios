 ...
 * forwards the methods to a `TIOModelRepositoryClient`, allowing a repository
 * client to support background tranfers and progress updates.
 *
 * Inject an instance of this session delegate into the download NSURLSession
 * that you create for your `TIOFleClient` instance.
 */

@interface TIOMRClientSessionDelegate : NSObject <NSURLSessionDelegate, NSURLSessionTaskDelegate, NSURLSessionDownloadDelegate>
