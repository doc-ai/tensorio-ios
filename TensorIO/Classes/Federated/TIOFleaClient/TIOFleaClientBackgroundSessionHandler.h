//
//  TIOFleaClientBackgroundSessionHandler.h
//  TensorIO
//
...
typedef void (^TIOFleaClientBackgroundCompletionHandler)(void);

/**
 * A shared singleton for sharing background URL session completion handlers
 * between an application delegate and a `TIOFleaClient`.
 */

@interface TIOFleaClientBackgroundSessionHandler : NSObject
...
@property (nullable) TIOFleaClientBackgroundCompletionHandler handler;
