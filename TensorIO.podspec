...
Pod::Spec.new do |s|
  ...
  s.description      = 'Perform inference with TensorFlow Lite or inference and training with full TensorFlow models using all the conveniences of Objective-C or Swift'
